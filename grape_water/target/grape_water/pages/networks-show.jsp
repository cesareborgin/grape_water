                                    ...
                                    <div class="box box-widget">
                                        <div class="box-header with-border">
                                            <div class="user-block">
                                                <img class="img-circle" src="../img/backgroud.jpg" alt="User Image">
                                                <span class="username"><a href="#">${network.objName}</a></span>
                                                <span class="description">${network.dateStr}</span>
                                            </div>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <img src="${network.photo}" style="width: 100%;height: 100%">
                                        </div>
                                    </div>
