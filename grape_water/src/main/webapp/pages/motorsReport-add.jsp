...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/motors/save.do" method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker-a1" name="testTime">
                            </div>
                        </div>
                        <div class="col-md-2 title">内部名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="inName" placeholder="内部名称" value="">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="voltage" placeholder="电机电压" value="">
                        </div>
                        <div class="col-md-2 title">电机电流（A）</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="electricity" placeholder="电机电流" value="">
                        </div>
                        <div class="col-md-2 title">输入功率（kw）</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="inputPower" placeholder="输入功率" value="">
                        </div>
                        <div class="col-md-2 title">输出功率（kw）</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="outputPower" placeholder="输出功率" value="">
                        </div>
                        <div class="col-md-2 title">运行效率（%）</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="operateEfficiency" placeholder="运行效率" value="">
                        </div>
                        <div class="col-md-2 title">吨·百米耗电量</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="energyUnit" placeholder="kW·h/(t·hm)" value="">
                        </div>
                        <div class="col-md-2 title">耗电量（kW·h）</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="energyUsed" placeholder="耗电量" value="">
                        </div>
