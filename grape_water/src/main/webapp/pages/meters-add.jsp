...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>计量器台账<small>计量器台账表单</small></h1>
            <ol class="breadcrumb">
        ...
        <form action="${pageContext.request.contextPath}/meters/save.do" method="post">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="meterName" placeholder="计量器名称" value="">
                        </div>
                        <div class="col-md-2 title">系统编号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="modelCode" placeholder="系统编号" value="">
                        </div>

                        <div class="col-md-2 title">生产产家</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="生产产家" name="productName" value="">
                        </div>

                        <div class="col-md-2 title">计量器型号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="计量器型号" name="meterType" value="">
                        </div>
                        <div class="col-md-2 title">测量精度</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="测量精度" name="measureAccuracy" value="">
                        </div>
                        <div class="col-md-2 title">口径（mm）</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="口径" name="caliber" value="">
                        </div>
                        <div class="col-md-2 title">防爆等级</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="防爆等级" name="protector" value="">
                        </div>
                        <div class="col-md-2 title">计量器规格</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="计量器规格" name="specification" value="">
                        </div>
                        <div class="col-md-2 title">通讯方式</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="通讯方式" name="coumMethod" value="">
                        </div>
                        <div class="col-md-2 title">安装位置</div>
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%" name="location" id="location" onchange="getCode()">
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%" name="locationCode" id="locationCode">
                            </select>
                        </div>
